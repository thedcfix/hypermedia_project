	...
	if(isset($_GET['category'])) {
        ...
        $frammento =$doc->createDocumentFragment();
         ...
         while($row = mysqli_fetch_array($res)){
             ...
             $aggiunta = '<div class="col-sm-4" align="center" style="float"><a href="servizio.php?id='.$row["id"].'"><img src="'.$row["img"].'" style="width:160px; height:160px"></img><p>'.$row["nome"].'<br/></p></a><p>'.$row["descrizione"].'</p><a href="servizio.php?id='.$row["id"].'"><button>Scopri</button></a></div>';
